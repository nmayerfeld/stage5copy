...
public class DemoWithLeaderKilledNoRequestsSentUntilNewOneBackUp {
    ...
    public DemoWithLeaderKilledNoRequestsSentUntilNewOneBackUp() throws Exception {
        ...
        System.out.println("killing leader at "+System.currentTimeMillis());
        this.servers.get(4).shutdown();
        System.out.println("finished killing leader at "+System.currentTimeMillis());
        try {
            Thread.sleep(60000);
        }
        catch (InterruptedException e) {
    ...
    public static void main(String[] args) throws Exception {
        new DemoWithLeaderKilledNoRequestsSentUntilNewOneBackUp();
    }
}
