...
public class UDPMessageReceiver extends Thread implements LoggingServer {
    ...
    public void shutdown() {
        interrupt();
        this.incomingGossipMessages=null;
        this.incomingElectionMessages=null;
    }
        ...
        while (!this.isInterrupted()) {
            try {
                ...
                if (sendLeader(received)) {
                    ...
                    this.logger.log(Level.FINEST,"sending message to IncomingGossip");
                    ...
                    this.logger.log(Level.FINEST,"sending message to IncomingElection");
                    //use interrupt-safe version, i.e. offer
                    boolean done = false;
                    while(!done){
